const {
  SlashCommandBuilder, EmbedBuilder, ButtonStyle, ButtonBuilder, ActionRowBuilder,
} = require("discord.js");
...
const getTeamBoxscoresForDateRange = require("../helpers/getTeamBoxscoresForDateRange");
...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("simreportcard")
    .setDescription("Get a team report card for the last simulation")
