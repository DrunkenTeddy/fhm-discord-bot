...
const getLinesForTeam     = require("../helpers/getLinesForTeam");
...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("lines")
    .setDescription("Show your team lines."),
  ...
  async execute(interaction) {
    ...
    const embeds = await this.getTeamLinesEmbeds(interaction, teamID);
  ...
  async getTeamLinesEmbeds(interaction, teamID) {
